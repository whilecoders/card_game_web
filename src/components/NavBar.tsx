...
export function NavBar() {
  ...
  return (
    <nav 
      className="flex h-16  items-center gap-4 px-6 py-2 border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 shadow-sm">
      <MobileSidebar />
      
      <div className="flex items-center gap-2">
        <Icon icon="lucide:box" className="h-8 w-8 text-primary" />
        <h1 className={`text-2xl font-bold bg-gradient-to-r from-primary to-primary-foreground bg-clip-text text-transparent ${inter.className}`}>
          JQK
        </h1>
      </div>
      ...
      <div className="hidden md:flex flex-col items-end mr-4 pl-4">
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent className="w-56" align="end" forceMount>
          ...
          {/* <div className='w-full h-[0.07px] my-1 bg-gray-300' ></div> */}
          ...
          <div className='w-full h-[0.09px] my-1 bg-gray-200' ></div>

          <AlertDialog>
            <AlertDialogTrigger asChild>
              <div 
                className='text-red-600 hover:bg-red-50 cursor-pointer font-bold text-sm p-[6px] pl-[10px]'>
                  Log out
                </div>
            </AlertDialogTrigger>
